...
export default {
  ...
  methods: {
    ...
    toLink() {
      const name =
        this.program.type !== "course"
          ? "programs-program_id"
          : "courses-course";
      let params =
        this.$route.name === "programs-program_id"
          ? {}
          : { program_id: this.program.slug };
      if (this.program.type === "course") {
        params =
          this.$route.name === "courses-course"
            ? {}
            : { course: this.program.slug };
      }
      return {
        name,
        params
